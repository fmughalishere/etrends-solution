        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <Link
                href="/ceo-message"
                className="inline-flex items-center gap-3 mt-10 px-8 py-4 bg-[#0a1d4a] text-white rounded-full text-xs uppercase tracking-[3px] font-bold hover:bg-[#00aef0] transition-all"
              >
                Read CEO Message
              </Link>
            </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#0a1d4a] uppercase tracking-tighter">
              Our Core Pillars
            </h2>
